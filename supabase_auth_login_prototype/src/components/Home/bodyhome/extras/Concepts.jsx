    ...
    return (
        <Group  display="flex" justifyContent="center">
            ...
            <Box   maxW="400px" >
                ...
                <Text>jdsoaonfoisandoinasosknsfknsnfksnnssdsdsdkfnsdknfdskdkadmkasndkasdkasndkassndkasdjsnadjassnidn teffy y edison</Text>
            </Box>
<Separator orientation={{ base: "horizontal", lg: "vertical" }} size="lg" />
            <Box maxW="400px">
                ...
                <Text>jdsoaonfoisandoinasoisdasjndasjndjkasndjkasnjkdkaslndlkasndlkasndlkandsdafsasdjnasjdjsaadnskandkasn alvis y betsy</Text>
            </Box>
            </Flex>
